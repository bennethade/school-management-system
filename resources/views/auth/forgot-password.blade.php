...
<head>
  <meta charset="utf-8">
    ...
    <title>School System - Recover Password</title>
                            ...
                            <form method="POST" action="{{ route('password.email') }}">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" id="email" name="email" :value="old('email')" required class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Enter Your Email">
									</div>
								</div>
								  <div class="row">
