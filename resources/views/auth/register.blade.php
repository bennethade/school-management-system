...
<head>
  <meta charset="utf-8">
    ...
    <title>School System - Registration </title>
							...
							<form method="POST" action="{{ route('register') }}">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="text" id="name" for="name" name="name" :value="old('name')" required class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Full Name">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" id="password" name="password" required class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" id="password_confirmation" name="password_confirmation" required class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Retype Password">
									</div>
								</div>
								  <div class="row">
									<div class="col-12">
