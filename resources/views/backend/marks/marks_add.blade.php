     ...
     $.ajax({
      ...
      success: function (data) {
        ...
        $.each( data, function(key, v){
          ...
          '<td><input type="text" class="form-control form-control-sm" name="ca1[]" ></td>'+
          '<td><input type="text" class="form-control form-control-sm" name="ca2[]" ></td>'+
          '<td><input type="text" class="form-control form-control-sm" name="ca3[]" ></td>'+
          '<td><input type="text" class="form-control form-control-sm" name="exam[]" ></td>'+
          '</tr>';
        });
