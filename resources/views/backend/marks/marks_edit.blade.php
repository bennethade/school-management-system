      ...
      <section class="content">
        <div class="row">
            ...
            {{-- /////////////  MARK ENTRY TABLE///////////////////// --}}
                            ...
                            <div class="row d-none" id="marks-entry">   <!--d-none means it should not be visible at first-->
                                <div class="col-md-12">
     ...
     $.ajax({
      ...
      success: function (data) {
        ...
        $.each( data, function(key, v){
          ...
          '<td><input type="text" class="form-control form-control-sm" name="ca1[]" value=" '+v.ca1 +' "></td>'+
          '<td><input type="text" class="form-control form-control-sm" name="ca2[]" value=" '+v.ca2 +' "></td>'+
          '<td><input type="text" class="form-control form-control-sm" name="ca3[]" value=" '+v.ca3 +' "></td>'+
          '<td><input type="text" class="form-control form-control-sm" name="exam[]" value=" '+v.exam +' "></td>'+
          '</tr>';
        });
...
{{-- FOR "GET STUDENT SUBJECTS" --}}
{{-- ============ Script to show all subjects when you choose year and class to enter marks ================= --}}
<script type="text/javascript">
    $(function(){
