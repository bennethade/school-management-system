        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="box bb-3 border-warning">
                    ...
                    <h4 class="box-title">Manage <strong>Marksheet PDF</strong></h4>
                    </div>

                    <div class="box-body" style="border: solid 1px; padding:10px;">
                        <div class="row"> <!--Start 1st Row-->
                            <div class="col-md-2 text-center" style="float: right;">
                                <img src="{{ url('upload/logo.png') }}" style="width:120px; height:100px;">
                            </div>
                            ...
                            <div class="col-md-4 text-center" style="float: left;">
                                <h4><strong>Anchor Hub ICT Shool</strong></h4>
                                <h6><strong>Kubwa, FCT Abuja</strong></h6>
